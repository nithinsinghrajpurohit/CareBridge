...
const VolunteerHub = ({ needs, onVolunteer }) => {
  ...
  const displayNeeds = needs.length > 0 ? needs : [
    ...
    { id: 5, title: 'Children educational materials', category: 'Education', urgency: 'Low', location: 'Westside Family Center', latitude: 40.7306, longitude: -74.0021, description: 'Books, art supplies for children at temporary family housing.', postedBy: 'Westside Volunteers', contactPhone: '+1-555-1102', contactEmail: 'info@westsidevolunteers.net' },
    { id: 6, title: 'Emergency temporary shelter setup', category: 'Shelter', urgency: 'High', location: 'Riverside Community Park', latitude: 40.7450, longitude: -73.9780, description: 'Tents and temporary housing needed for 60 displaced families after building evacuation.', postedBy: 'City Emergency Services', contactPhone: '+1-555-0345', contactEmail: 'emergency@cityservices.org' },
    { id: 7, title: 'After-school tutoring program', category: 'Education', urgency: 'Medium', location: 'Midtown Learning Hub', latitude: 40.7550, longitude: -73.9850, description: 'Volunteer tutors needed for 30 displaced students falling behind in math and reading.', postedBy: 'EduBridge Initiative', contactPhone: '+1-555-0567', contactEmail: 'tutoring@edubridge.org' },
  ];
